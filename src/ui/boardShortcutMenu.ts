...
function injectStylesOnce(): void {
  ...
  style.textContent = `
    ...
    .cmdr-bsc-close { box-sizing: border-box; width: 28px; height: 28px; border-radius: 50%; border: none; background: #241f2d; color: #948fa3; font-size: 14px; font-weight: 700; }
